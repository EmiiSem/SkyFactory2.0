            ...
            <div class="carousel-slides">
                <div class="carousel-item">
                    ...
                    <div class="text__banner">
                        ...
                        <img src="/assest/img/main_telecope.png" alt="Баннерный телескоп" title="Sky-Watcher BK 707AZ2"
                            class="telescope__item-banner">
                    </div>
                </div>
                <div class="carousel-item">
...
<div class="cards">
    <div class="card">
        <div class="card__top">
            <a href="Cart_page.html" class="card__image">
                <img src="/assest/img/Products/cart1.png" alt="Телескоп Veber 360/50 рефрактор в кейсе"
    ...
    <div class="card">
        <div class="card__top">
            <a href="Cart_page.html" class="card__image">
                <img src="/assest/img/Products/cart3.jpg" alt="Телескоп Veber 350x60 Аз рефрактор"
    ...
    <div class="card">
        <div class="card__top">
            <a href="Cart_page.html" class="card__image">
                <img src="/assest/img/Products/cart4.jpg" alt="Телескоп Veber УМКА 76/300 рефлектор"
...
<div class="quastions">
    ...
    <div class="about__magazine">
        <h1 class="text_magazine">Магазин телескопов "SkyFactory"</h1>
        <div class="text_about">
            Мы рады приветствовать Вас в нашем специализированном магазине телескопов и аксессуарам к ним.
            Здесь Вы найдете широчайший выбор телескопов, и принадлежностей к ним, литературы и других
            сопутствующих товаров, а также получите
            ...
            Интерес к звёздам и к созерцанию неба обычно приводит человека к желанию купить телескоп, который
            позволит ему увидеть своими глазами все
            далекие сокровища космоса, так красочно описываемые в книгах. В телескоп вашему взору откроются
            Луна, планеты, кометы, многочисленные звёздные скопления,
        ...
        <div class="popup__item" id="popup_product_list">
            <div class="popup__product">
                <div class="popup__product-wrap">
                    <img src="/assest/img/Products/cart1.jpg" alt="Телескоп Veber 360/50 рефрактор в кейсе"
...
<script src="/assest/scripts/sliders.js"></script>
<script>
